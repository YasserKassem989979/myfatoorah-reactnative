import { Platform as Platform$1, ActivityIndicator, StyleSheet, Button, TouchableOpacity, Image, YellowBox, View } from 'react-native';
...
function executePaymentJson(request) {
    ...
    var sourceInfo = callerType + '-' + callerOS + '-' + Platform$1.Version + '-react_native-0.0.181';
    var jsonData = {
  ...
  createClass(MFInAppApplePayView$$1, [{
    ...
    value: function render() {
      ...
      if (this.state.link !== '') {
        ...
        return React.createElement(View, { style: { height: 60, margin: 0, marginTop: 0, flexDirection: 'column', padding: 0, justifyContent: 'space-evenly', width: '100%' } });
      }
    }
  }, {
